package istvangergo.javaeloadas.Oanda.v20;
...
import istvangergo.javaeloadas.Oanda.v20.transaction.StopLossDetails;
import istvangergo.javaeloadas.Oanda.v20.transaction.TakeProfitDetails;
import istvangergo.javaeloadas.Oanda.v20.transaction.TrailingStopLossDetails;
...
import istvangergo.javaeloadas.Oanda.v20.instrument.InstrumentContext;
import istvangergo.javaeloadas.Oanda.v20.position.PositionContext;
import istvangergo.javaeloadas.Oanda.v20.trade.TradeContext;
import istvangergo.javaeloadas.Oanda.v20.account.AccountContext;
import istvangergo.javaeloadas.Oanda.v20.transaction.TransactionContext;
import istvangergo.javaeloadas.Oanda.v20.transaction.Transaction;
import istvangergo.javaeloadas.Oanda.v20.transaction.TransactionAdapter;
import istvangergo.javaeloadas.Oanda.v20.user.UserContext;
import istvangergo.javaeloadas.Oanda.v20.pricing.PricingContext;
import istvangergo.javaeloadas.Oanda.v20.order.OrderContext;
import istvangergo.javaeloadas.Oanda.v20.order.Order;
import istvangergo.javaeloadas.Oanda.v20.order.OrderAdapter;
import istvangergo.javaeloadas.Oanda.v20.primitives.NullableTypeAdapterFactory;
import istvangergo.javaeloadas.Oanda.v20.primitives.AcceptDatetimeFormat;
    ...
    public Context(
        ...
        this.gson = new GsonBuilder()
            ...
            .registerTypeAdapterFactory(
                new NullableTypeAdapterFactory<TakeProfitDetails>(
                    TakeProfitDetails.class
                )
            )
            .registerTypeAdapterFactory(
                new NullableTypeAdapterFactory<StopLossDetails>(
                    StopLossDetails.class
                )
            )
            .registerTypeAdapterFactory(
                new NullableTypeAdapterFactory<TrailingStopLossDetails>(
                    TrailingStopLossDetails.class
                )
            )
            .create();
